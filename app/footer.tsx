  ...
  return (
    <footer className="bg-black p-4 px-10 text-white">
      <div className="container mx-auto flex flex-col md:flex-row justify-around py-5">
          <Image src="/img/saalik-logo.png" alt="SAALIK logo" width={170} height={100} />
        <div className="flex flex-col items-center mb-2">
          <h1 className="text-2xl text-green-500 font-bold text-center my-2">Quick Links</h1>
          <Link href="#" className='hover:text-green-700 hover:underline p-2'> Home</Link>
          <Link href="#" className='hover:text-green-700 hover:underline p-2'>About</Link>
          <Link href="#" className='hover:text-green-700 hover:underline p-2'>Services</Link>
          <Link href="#" className='hover:text-green-700 hover:underline p-2'>Contact</Link>
        </div>
        <div className='flex flex-col items-center mb-2'>
          <h1 className="text-2xl text-green-500 font-bold text-center my-2 ">Company</h1>
          <Link href='/about' className='hover:text-green-700 hover:underline p-2'>About</Link>
          <Link href='/team' className='hover:text-green-700 hover:underline p-2'>Team</Link>
          <Link href='/motivation' className='hover:text-green-700 hover:underline p-2'>Motivation</Link>
        </div>
        <div className='flex flex-col items-center'>
          <h1 className="text-2xl text-green-500 font-bold text-center my-2 ">Socials</h1>
          <div className='flex justfy-around'>
            <div className='flex flex-col justify-around'>
              <a href="https://www.facebook.com/saalik" target="_blank" rel="noopener noreferrer" className='flex hover:text-green-800 p-2'>
                ...
                <p className='text-green-500 ml-1'>/saalik</p>
              </a>
              ...
              <a href="https://www.instagram.com/saalik0" target="_blank" rel="noopener noreferrer" className='flex hover:text-green-800 p-2'>
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 32 32" fill="currentColor">
                ...
                <p className='text-green-500'>/saalik0</p>
              </a>
            </div>
          </div>
        </div>
